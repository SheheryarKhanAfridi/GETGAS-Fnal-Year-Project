...
const VendorCancelMail = async (req, res, next) => {
    ...
    let response = {
        body: {
            name: Name,
            intro: 'Your order has been Cancel By Vendor.',
            table: {
                data: [
    ...
    let Umessage = {
        from: EMAIL,
        to: CustomerEmail,
        subject: 'Order has been Cancel by vendor',
        html: mail
    };
...
module.exports = { VendorCancelMail };
